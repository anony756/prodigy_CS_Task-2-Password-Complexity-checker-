...
def check_password_complexity(password):
    ...
    if length_criteria and uppercase_criteria and lowercase_criteria and digit_criteria and special_char_criteria:
        return "It's a Strong It's unbreakable.........."
    else:
        feedback = "Weak password. Needs more improvement to make it strong.:\n"
        if not length_criteria:
            feedback += "- Make sure that the password is at least 8 characters long\n"
